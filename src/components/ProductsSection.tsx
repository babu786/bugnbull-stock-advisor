                      ...
                      <div className="relative">
                        {/* Header with gradient background */}
                          <div className={`relative bg-gradient-to-br ${product.gradient.replace('/10', '').replace('/5', '')} rounded-t-lg -m-6 mb-0 p-8 text-center`}>
                            <div className="absolute inset-0" style={{ backgroundColor: `hsl(var(${product.color.replace('text-', '--')}) / 0.6)` }} aria-hidden="true"></div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                          <Button className="group relative h-24 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-600 hover:from-purple-500 hover:via-purple-400 hover:to-indigo-500 text-white border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 overflow-hidden">
                            ...
                            <div className="relative z-10 text-center">
                              <p className="text-sm font-bold tracking-wide">Google Play</p>
                              <p className="text-xs opacity-90 font-medium">Android App</p>
                            </div>
                            <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-white/5 rounded-full blur-xl"></div>
                          </Button>
                          <Button className="group relative h-24 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-600 hover:from-sky-400 hover:via-blue-500 hover:to-indigo-500 text-white border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-r from-sky-300/20 via-blue-300/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            <div className="relative z-10 w-10 h-10 bg-white/25 backdrop-blur-sm rounded-xl flex items-center justify-center group-hover:bg-white/35 transition-all duration-300 group-hover:scale-110">
                              <Smartphone className="w-6 h-6 group-hover:rotate-12 transition-transform duration-300" />
                            </div>
                            <div className="relative z-10 text-center">
                              <p className="text-sm font-bold tracking-wide">App Store</p>
                              <p className="text-xs opacity-90 font-medium">iOS App</p>
                            </div>
                            <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-white/5 rounded-full blur-xl"></div>
                          </Button>
                        </div>
