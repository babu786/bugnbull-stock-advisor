                    ...
                    <div className="relative">
                      ...
                      <div className="p-6 pt-8">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                          ...
                          <Button className="group relative h-24 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br from-gray-800 via-gray-700 to-black hover:from-gray-700 hover:via-gray-600 hover:to-gray-800 text-white border-0 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 overflow-hidden">
